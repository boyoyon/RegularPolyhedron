...
TexCoords = np.empty((6, 2), np.float32)
...
def createTexture(c, moji):
    ...
    cv2.line(texture, (0, 0), (W - 1, 0), color, 3)
    cv2.line(texture, (0, H - 1), (W - 1, H - 1), color, 3)

    cv2.line(texture, (W // 4, 0), (0, H // 2), color, 3)
    cv2.line(texture, (0, H // 2), (W // 4, H - 1), color, 3)

    cv2.line(texture, (W * 3 // 4, 0), (W - 1, H // 2), color, 3)
    cv2.line(texture, (W - 1, H // 2), (W * 3 // 4, H - 1), color, 3)

    fontFace = cv2.FONT_HERSHEY_SIMPLEX
    
    cv2.putText(texture, text = '0', org = (70,40), fontFace = fontFace, fontScale = 1.0, 
            color = color, thickness = 2, lineType = cv2.LINE_4) 

    cv2.putText(texture, text = '1', org = (170,40), fontFace = fontFace, fontScale = 1.0, 
            color = color, thickness = 2, lineType = cv2.LINE_4) 
    
    cv2.putText(texture, text = '2', org = (220,135), fontFace = fontFace, fontScale = 1.0, 
            color = color, thickness = 2, lineType = cv2.LINE_4) 
    
    cv2.putText(texture, text = '3', org = (170,245), fontFace = fontFace, fontScale = 1.0, 
            color = color, thickness = 2, lineType = cv2.LINE_4) 
    
    cv2.putText(texture, text = '4', org = (70,245), fontFace = fontFace, fontScale = 1.0, 
            color = color, thickness = 2, lineType = cv2.LINE_4) 
    
    cv2.putText(texture, text = '5', org = (15,135), fontFace = fontFace, fontScale = 1.0, 
            color = color, thickness = 2, lineType = cv2.LINE_4) 
    

    cv2.putText(texture, text = moji, org = (105 - (len(moji) - 1) * 20, 150), fontFace = fontFace, fontScale = 2.0, 
