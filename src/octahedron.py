...
WIN_TITLE = "Octahedron"  # ウィンドウのタイトル / Window title
...
points = np.empty((6, 3), np.float32)
faces = np.empty((8, 3), np.int32)
...
def main():
    ...
    print(':')
    print('python %s <texture image_1> <texture image_2> ... <texture image_8>' % argv[0])
