...
def createTexture(color, moji):
    ...
    cv2.putText(texture, text = moji, org = (110,150), fontFace = fontFace, fontScale = 2.0, 
            color = color, thickness = 2, lineType = cv2.LINE_4) 
...
def createDodecahedron(size):
    ...
    textureImages.append(createTexture((0, 255, 0), '0'))
    ...
    textureImages.append(createTexture((0, 0, 255), '1'))
    ...
    textureImages.append(createTexture((220, 0, 220), '2'))
    ...
    textureImages.append(createTexture((255, 0, 0), '3'))
